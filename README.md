...
- [**dissector-agent**](https://github.com/SufficientDaikon/dissector-agent)  reverse-engineers any codebase into human and Ai agent readable documents through 13 analysis phases, covering architecture, conventions, APIs, testing, and security.
